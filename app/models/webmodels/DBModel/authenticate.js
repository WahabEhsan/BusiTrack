...
/**This attempts to find a bt_user document containing a hash matching that of one generated when attempting to login**/
async function auth(client, hash){
    const result = await client.db("busitrack").collection("bt_user").find({id: hash});
